...
| ------ | ---------- | --- | --- |
| [0.1: The First Day](lesson_01.md) | Identify the class they are taking. List the high-level goals of the course. Describe classroom procedures, rules, and norms. | N/A | [0.1 Slide Deck](https://github.com/TEALSK12/introduction-to-computer-science/raw/master/slidedecks/TEALS%20SNAP%200.1.pptx) |
...
| Lesson | Objectives | Lab | Slide Decks |
| ------ | ---------- | --- | --- |
| [1.1.1: Welcome to SNAP](lesson_11.md) | Define and identify "blocks," "scripts," "sprites," and "the stage" in SNAP. Write simple SNAP programs. Describe what simple SNAP programs do without executing the code.  | Welcome to SNAP! | [1.1 Slide Deck](https://github.com/TEALSK12/introduction-to-computer-science/raw/master/slidedecks/TEALS%20SNAP%201.1.pptx) |
...
| Lesson | Objectives | Lab | Slide Decks |
| ------ | ---------- | --- | --- |
| [2.1: Loops](lesson_21.md) | Define "loop" in a programming context. Explain why loops are useful. Implement simple repeat and forever loops in SNAP. Utilize loops to reduce redundancy in code. | Squares and Triangles Redux | [2.1 Slide Deck](https://github.com/TEALSK12/introduction-to-computer-science/raw/master/slidedecks/TEALS%20SNAP%202.1.pptx) |
| [2.2: Nested Loops](lesson_22.md) | Use nested loops to solve programming problems. | Another Brick in the Wall | [2.2 Slide Deck](https://github.com/TEALSK12/introduction-to-computer-science/raw/master/slidedecks/TEALS%20SNAP%202.2.pptx) |
| [2.3: Inputs and Conditionals](lesson_23.md) | Ask for and receive user input in a SNAP program. Use simple conditional (if and if-else) blocks to alter control flow in a SNAP program. | What Shape Is That? | [2.3 Slide Deck](https://github.com/TEALSK12/introduction-to-computer-science/raw/master/slidedecks/TEALS%20SNAP%202.3.pptx) |
| [2.4: Variables](lesson_24.md) | Use variables to track values throughout a program. | Guessing Game | [2.4 Slide Deck](https://github.com/TEALSK12/introduction-to-computer-science/raw/master/slidedecks/TEALS%20SNAP%202.4.pptx) |
| [2.5: Boole in the House](lesson_25.md) | Define and identify Boolean expressions and operators. Evaluate Boolean expressions. Utilize Boolean operators (and/or/not) to create compound conditions. | Triangle of All Kinds | [2.5 Slide Deck](https://github.com/TEALSK12/introduction-to-computer-science/raw/master/slidedecks/TEALS%20SNAP%202.5.pptx) |
