...
## Part 5: Experiment with Drawing Commands
...
**5.1) What do these blocks do? (write an explanation next to each block)?**
...
## Part 6: Follow that Mouse

![forever go to mouse x-y](forevergotomouse.png)

**6.1) What do you think the script above will do?**
...
**6.2) What happens when you drag the mouse to a different part of the screen while the program is running?**

**6.3) How does program's behavior change when you modify the `go to` block as shown below?**

![go to mouse x + 30, y](gotomousex30.png)

## Part 7: Forever and a Day
...
**7.1) How many times will the sprite say "Hello"?**
...
**7.2) Assuming the sprite starts in the middle of the stage and pointing in direction 90, where would it end up after running this script?**
...
**7.3) What would appear on the screen when this script is run?**
...
**7.4) Assuming the sprite started in the middle of the stage facing right, what kind of drawing would the sprite make?**
