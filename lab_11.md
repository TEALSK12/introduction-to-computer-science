...
**1.1) Below, fill in the name of the category to which each block belongs.**
...
**2.1) Try recreating the following script in the scripting area in SNAP.**
...
**4.1) What do these blocks do? (write an explanation next to each block)?**
...
**4.2) Does the _turn_ block change the sprite's x and/or y position?**
...
**5.2) What happens when you drag the mouse to a different part of the screen while the program is running?**

**5.3) How does program's behavior change when you modify the `go to` block as shown below?**
...
**6.1) How many times will the sprite say "Hello"?**
...
**6.2) Assuming the sprite starts in the middle of the stage and pointing in direction 90, where would it end up after running this script?**
...
**6.3) What would appear on the screen when this script is run?**
...
**6.4) Assuming the sprite started in the middle of the stage facing right, what kind of drawing would the sprite make?**
